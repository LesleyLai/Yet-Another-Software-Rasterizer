...
option(YASR_WARNING_AS_ERROR "Treats compiler warnings as errors" ON)
if (MSVC)
    target_compile_options(compiler_options INTERFACE /W4 "/permissive-")
    if (YASR_WARNING_AS_ERROR)
...
option(YASR_ENABLE_PCH "Enable Precompiled Headers" OFF)
if (YASR_ENABLE_PCH)
...
option(YASR_USE_ASAN "Enable the Address Sanitizers" OFF)
if (YASR_USE_ASAN)
...
option(YASR_USE_TSAN "Enable the Thread Sanitizers" OFF)
if (YASR_USE_TSAN)
...
option(YASR_USE_MSAN "Enable the Memory Sanitizers" OFF)
if (YASR_USE_MSAN)
...
option(YASR_USE_UBSAN "Enable the Undefined Behavior Sanitizers" OFF)
if (YASR_USE_UBSAN)
